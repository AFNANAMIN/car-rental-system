...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Frequent Users Report &middot; GT Car Rental</title>
  ...
  <body>
    <div class="container">
        ...
        <h2 class="form-signin-heading">Frequent Users Report</h2>
        <br>
        <br>
<table border="1">
<thead>
...
<?php
   $outputTable = calcFrequentUsers();
   foreach ($outputTable as $loopRow) {
      echo "<tr><td>".$loopRow[0]."</td><td>".$loopRow[1]."</td><td>".$loopRow[2]."</td></tr>\n";
   }
?>
</table>
<table>
